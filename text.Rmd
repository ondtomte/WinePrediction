...
`proc.base(final.rf.model.list$testMSE)`

#5.3 Learning rate
After finding a good model we wanted to answers if more data would create an even better model.
To do this we calculated and plotted a diagram with MSE as an function of training data.
As you can see the validation MSE is still shrinking fast. 
