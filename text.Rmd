...
barplot(bar.matrix, beside = TRUE, ylim = c(0,0.8), names = c("Baseline","LM","Lasso","Ridge","TPS","Local reg.","RF", "", ""), las = 2, col = cust.col, ylab = "Validation MSE")
...
$Precision=\frac{567}{567+54}\approx 0.91$

$Recall=\frac{567}{567+104}\approx 0.85$
