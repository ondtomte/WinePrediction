...
generic.plot(neighbors, c(30, 100), c(.10,.50), "Number of neighbors", loc.reg.mse)
```
...
```{r}
cust.col <- append(colors(distinct = TRUE)[1],colors(distinct = TRUE)[1 + seq(2,length(dataSets))*30])
