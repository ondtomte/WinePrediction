...
We begin by simply regressing quality on each of the individual attributes. The highest mutual information was observed between quality and density, we therefore naively except this model to perform best (given that the relation between density and quality is actually linear, plotting our data shows a slight such tendency):
...
For the untransformed data, the more attributes that were removed the higher the MSE became. This fact indicates all of the attributes are relevant.
